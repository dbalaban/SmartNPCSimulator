...
SmartActor::SmartActor(GridWorld* world,
    ...
    discounting_factor(reader.getParam<double>("SmartActor", "discounting_factor", 0.99)),
    learning_rate_actor(reader.getParam<double>("SmartActor", "learning_rate_actor", 0.01)),
    learning_rate_critic(reader.getParam<double>("SmartActor", "learning_rate_critic", 0.01)),
    decay_factor(1.0),
